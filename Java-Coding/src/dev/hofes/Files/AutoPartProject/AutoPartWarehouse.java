...
import dev.hofes.Files.AutoPartProject.Order.Item;
...
public class AutoPartWarehouse {
    ...
    AutoPartWarehouse(String partPath, String orderPath) {
        ...
        try {
            File file = new File(Paths.get(partPath).toAbsolutePath().toString());
            ...
            file = new File(Paths.get(orderPath).toAbsolutePath().toString());
